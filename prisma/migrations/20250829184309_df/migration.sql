-- CreateEnum
CREATE TYPE "public"."Role" AS ENUM ('super_admin', 'executive', 'admin', 'collaborator', 'professional', 'support', 'preset');
...
-- CreateEnum
CREATE TYPE "public"."CampaignFrequency" AS ENUM ('semestral', 'anual', 'trimestral', 'mensal');

-- CreateEnum
CREATE TYPE "public"."CampaignStatus" AS ENUM ('active', 'inactive', 'completed', 'cancelled');
...
CREATE TABLE "public"."campaign" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "frequency" "public"."CampaignFrequency" NOT NULL DEFAULT 'semestral',
...
-- CreateTable
CREATE TABLE "public"."campaign_document" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "description" TEXT,
...
-- CreateTable
CREATE TABLE "public"."_campaignToproject" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_campaignToproject_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_campaignToproject_B_index" ON "public"."_campaignToproject"("B");
...
-- AddForeignKey
ALTER TABLE "public"."submitted_form" ADD CONSTRAINT "submitted_form_campaign_id_fkey" FOREIGN KEY ("campaign_id") REFERENCES "public"."campaign"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."campaign" ADD CONSTRAINT "campaign_created_by_id_fkey" FOREIGN KEY ("created_by_id") REFERENCES "public"."profile"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."campaign" ADD CONSTRAINT "campaign_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."campaign_document" ADD CONSTRAINT "campaign_document_campaign_id_fkey" FOREIGN KEY ("campaign_id") REFERENCES "public"."campaign"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."campaign_document" ADD CONSTRAINT "campaign_document_uploaded_by_id_fkey" FOREIGN KEY ("uploaded_by_id") REFERENCES "public"."profile"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."_campaignToproject" ADD CONSTRAINT "_campaignToproject_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."campaign"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_campaignToproject" ADD CONSTRAINT "_campaignToproject_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."project"("id") ON DELETE CASCADE ON UPDATE CASCADE;
